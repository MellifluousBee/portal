...
import org.stlsymphony.portal.models.dao.ShiftCalendarDao;
...
public abstract class AbstractController {
	...
	@Autowired
	protected ShiftCalendarDao shiftCalendarDao;
    ...
    protected void setUserInSession(HttpSession session, User user) {
    	session.setAttribute(userSessionKey, user.getUserUid());
    }
